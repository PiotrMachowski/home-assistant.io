...
In order to use this function you have to define `preload_translations` in [basic configuration](/docs/configuration/basic) to enable preloading translations for selected languages after start of Home Assistant.
